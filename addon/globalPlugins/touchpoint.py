...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
    ...
    def __init__(self):
        ...
        if not DEPENDENCIES_AVAILABLE:
            ...
            self.logMessage("To install manually, open NVDA Python Console (NVDA+Control+Z) and run:")
            self.logMessage("import subprocess, sys; subprocess.check_call([sys.executable, '-m', 'pip', 'install', 'numpy', 'dxcam', 'opencv-python'])")
    ...
    def _initialize_async(self):
        ...
        try:
            ...
            # Initialize camera (but don't start capturing yet)
